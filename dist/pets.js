...
/******/ 	return __webpack_require__(__webpack_require__.s = "./pages/pets/js/pets.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./pages/pets/sass/pets.scss":
/*!****************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./pages/pets/sass/pets.scss ***!
  \****************************************************************************************************************/
/*! exports provided: default */
...
var Hamburger = /*#__PURE__*/function () {
  ...
  _createClass(Hamburger, [{
    ...
    value: function changeStyles() {
      ...
      this.header.classList.toggle('body_overlay', this.isActive);
    }
  }, {
...
/* harmony import */ var _pets_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./pets.json */ "./pages/pets/js/pets.json");
var _pets_json__WEBPACK_IMPORTED_MODULE_0___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./pets.json */ "./pages/pets/js/pets.json", 1);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var Popup = /*#__PURE__*/function () {
  ...
  _createClass(Popup, [{
    ...
    value: function init() {
      ...
      setTimeout(this.setTransition.bind(this), 0);
    }
  }, {
    key: "setTransition",
...
var Slider = /*#__PURE__*/function () {
  function Slider() {
    ...
    this.currentPointer = document.getElementById('current');
  ...
  _createClass(Slider, [{
    ...
    value: function init() {
      this.updateCards();
      this.firstBtn.addEventListener('click', this.moveToStart.bind(this));
      this.lastBtn.addEventListener('click', this.moveToEnd.bind(this));
      this.prevBtn.addEventListener('click', this.moveToPrev.bind(this));
    ...
    value: function getCountCardsOnPage() {
      ...
      var mediaSixCardsWidth = 1279;
      var mediaThreeCardsWidth = 767;
      if (widthContainer > mediaSixCardsWidth) return 8;else if (widthContainer > mediaThreeCardsWidth) return 6;else return 3;
    } // setCurrentStyleForCardOnload() {
    //   const listOfCards = document.querySelectorAll('.pets-slider__item');
    //   for (let i = 0; i < this.countCardsOnPage; i++) {
    ...
    value: function getRandomPets() {
      var result = [];
      var countPetsRepeating = 6;

      for (var i = 0; i < countPetsRepeating; i++) {
        var petsListRandom = this.petsList.slice();

        for (var j = petsListRandom.length; j > 0; j--) {
          var petIndex = Math.floor(Math.random() * j);
          petsListRandom.push(petsListRandom.splice(petIndex, 1)[0]);
        }

        result = [].concat(_toConsumableArray(result), _toConsumableArray(petsListRandom));
      }

      return result;
    }
  }, {
    key: "sort6recursively",
    value: function sort6recursively(list) {
      var _this = this;

      var length = list.length;

      var _loop = function _loop(i) {
        var stepList = list.slice(i * 6, i * 6 + 6);

        var _loop2 = function _loop2(j) {
          var duplicatedItem = stepList.find(function (item, ind) {
            return item.name === stepList[j].name && ind !== j;
          });

          if (duplicatedItem !== undefined) {
            var ind = i * 6 + j;
            var which8OfList = Math.trunc(ind / 8);
            list.splice(which8OfList * 8, 0, list.splice(ind, 1)[0]);

            _this.sort6recursively(list);
          }
        };
    ...
    value: function updateCards() {
      ...
      var listPets = this.getRandomPets();
      listPets = this.sort6recursively(listPets);
      listPets.forEach(function (pet) {
        var petElement = _this2.renderPet(pet);

        _this2.slider.appendChild(petElement);
      });
      this.slider.transition = '0.5s';
    }
  }, {
    key: "moveSlider",
    value: function moveSlider() {
      var offset;
      if (this.countCardsOnPage === 8) offset = 930;else if (this.countCardsOnPage === 6 || this.countCardsOnPage === 3) offset = 1395;
      this.slider.style.top = "-".concat(offset * this.counter, "px");
    }
  }, {
    key: "moveToStart",
    value: function moveToStart(e) {
      this.isRun = true;
      this.counter = 0;
      this.moveSlider();
      this.changeBtnStyles(e);
      this.setTimeoutOfClickSlider();
    }
  }, {
    key: "moveToEnd",
    value: function moveToEnd(e) {
      this.isRun = true;
      this.counter = Math.trunc(this.countCards / this.countCardsOnPage) - 1;
      this.moveSlider();
      this.changeBtnStyles(e);
      this.setTimeoutOfClickSlider();
    }
    ...
    key: "moveToNext",
    value: function moveToNext(e) {
      e.preventDefault();
      var maxCountPages = Math.trunc(this.countCards / this.countCardsOnPage) - 1;
      if (this.counter >= maxCountPages) return;
      this.counter++;
      this.isRun = true;
      this.moveSlider();
      this.changeBtnStyles(e);
    ...
    key: "changeBtnStyles",
    value: function changeBtnStyles(e) {
      var maxCountPages = Math.trunc(this.countCards / this.countCardsOnPage) - 1;
      this.updateCurrentPointer();

      if (this.counter <= 0) {
        this.prevBtn.classList.add('pets-controls__button_inactive');
        this.firstBtn.classList.add('pets-controls__button_inactive');
        this.prevBtn.disabled = true;
        this.firstBtn.disabled = true;
        this.nextBtn.classList.remove('pets-controls__button_inactive');
        this.lastBtn.classList.remove('pets-controls__button_inactive');
        this.nextBtn.disabled = false;
        this.lastBtn.disabled = false;
      } else if (this.counter >= maxCountPages) {
        this.nextBtn.classList.add('pets-controls__button_inactive');
        this.lastBtn.classList.add('pets-controls__button_inactive');
        this.nextBtn.disabled = true;
        this.lastBtn.disabled = true;
        this.prevBtn.classList.remove('pets-controls__button_inactive');
        this.firstBtn.classList.remove('pets-controls__button_inactive');
    ...
    key: "setTimeoutOfClickSlider",
    value: function setTimeoutOfClickSlider() {
      var that = this;
      setTimeout(function () {
        that.isRun = false;
      }, 500);
    ...
    key: "updateCurrentPointer",
    value: function updateCurrentPointer() {
      console.log(this.counter);
      this.currentPointer.innerText = this.counter + 1;
    } //   //EventHandlers
    //   moveToLeft() {
    //     if (this.isRun) return;
    //     this.isRun = true;
    //     const isPrev = true;
    //     const arrCards = document.querySelectorAll('.pets-slider__item');
    //     const that = this;
    //     arrCards.forEach((card) => {
    //       card.style.transform = `translateX(${this.countCardsOnPage * 100}%)`;
    //     });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _sass_pets_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../sass/pets.scss */ "./pages/pets/sass/pets.scss");
/* harmony import */ var _Hamburger_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Hamburger.js */ "./pages/pets/js/Hamburger.js");
/* harmony import */ var _Popup_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Popup.js */ "./pages/pets/js/Popup.js");
/* harmony import */ var _Slider_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Slider.js */ "./pages/pets/js/Slider.js");
...
hamburger.init();
var slider = new _Slider_js__WEBPACK_IMPORTED_MODULE_3__["Slider"]();
slider.init();
var popup = new _Popup_js__WEBPACK_IMPORTED_MODULE_2__["Popup"]();
popup.init();

/***/ }),

/***/ "./pages/pets/js/pets.json":
/*!*********************************!*\
  !*** ./pages/pets/js/pets.json ***!
  \*********************************/
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_pets_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !../../../node_modules/css-loader/dist/cjs.js!../../../node_modules/sass-loader/dist/cjs.js!./pets.scss */ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./pages/pets/sass/pets.scss");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_pets_scss__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ __webpack_exports__["default"] = (_node_modules_css_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_pets_scss__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
